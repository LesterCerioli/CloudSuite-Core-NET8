...
{
    public class CompanyCoreConsumer : BackgroundService
    {
        private readonly RabbitMqSettings _settings;
        private readonly ILogger<CompanyCoreConsumer> _logger;
        private readonly IConnection _connection;
        private readonly IModel _channel;

        public CompanyCoreConsumer(IOptions<RabbitMqSettings> options, ILogger<CompanyCoreConsumer> logger)
        {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(queue: _settings.RabbitMqConfiguration.Queues["Company"], autoAck: false, consumer: consumer);
