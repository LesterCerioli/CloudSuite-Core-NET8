...
{
    public class CountryCoreConsumer : BackgroundService
    {
        private readonly RabbitMqSettings _settings;
        private readonly ILogger<CountryCoreConsumer> _logger;
        private readonly IConnection _connection;
        private readonly IModel _channel;

        public CountryCoreConsumer(IOptions<RabbitMqSettings> options, ILogger<CountryCoreConsumer> logger)
        {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(queue: _settings.RabbitMqConfiguration.Queues["Country"], autoAck: false, consumer: consumer);
