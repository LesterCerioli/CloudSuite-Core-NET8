...
namespace CloudSuite.Modules.Application.Tests.Services
{
    public class AddressAppServiceTests
    {
        ...
        public async Task GetByAddressLine_ShouldReturnsCompanyViewModel(string addressLine, string contactName)
        {
            ...
            var addressEntity = new Address(Guid.NewGuid(), new City(Guid.NewGuid(), "oudricandrai", new State(Guid.NewGuid(), "ba", "Bahia", new Country(Guid.NewGuid(),"Salvaodr", "123", true, true, true, false, false), Guid.NewGuid())), new District(), "John Doe", addressLine);
            ...
            // Act
            var result = await tomadorServicoAppService.GetByAddressLine(addressLine);
        ...
        public async Task GetByAddressLine1_ShouldHandleInvalidMappingResult(string addressLine)
        {
            ...
            // Assert
            await Assert.ThrowsAsync<ArgumentException>(() => tomadorServicoAppService.GetByAddressLine(addressLine));
        }
